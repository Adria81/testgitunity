...
public class Minimap : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Matrix4x4 playerMatrix = gameCamera.localToWorldMatrix * Matrix4x4.Translate(Vector3.one * scale) *
        ...
        for (int i = 0; i < enemies.Length; i++)
        {
            ...
            Matrix4x4 enemyMatrix = gameCamera.localToWorldMatrix * Matrix4x4.Translate(Vector3.one * scale) *
